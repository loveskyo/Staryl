...
namespace Staryl.BLL
{
   ...
   public partial class ActivityApplyManager:BaseManager
   {
   private static readonly IActivityApplyDAL dal = DataAccess<IActivityApplyDAL>.CreateObject("ActivityApplyDAL");
                    ...
                    public bool CreateList(List<ActivityApplyInfo>  list)
                    { 
        ...
        {
           return  dal.GetByActivityId_StarId(  ActivityId,StarId);
        }
   }
}
