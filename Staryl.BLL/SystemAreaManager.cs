...
namespace Staryl.BLL
{
   ...
   public partial class SystemAreaManager:BaseManager
   {
   private static readonly ISystemAreaDAL dal = DataAccess<ISystemAreaDAL>.CreateObject("SystemAreaDAL");
                    ...
                    public bool CreateList(List<SystemAreaInfo>  list)
                    { 
