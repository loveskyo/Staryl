...
namespace Staryl.BLL
{
    ...
    public partial class ActivityManager
    {
        ...
        public List<ViewActivityInfo> GetPageListView(int pageIndex, int pageSize, string where, string orderBy, out int recordCount, bool doCount)
        {
            return dal.GetPageListView(pageIndex, pageSize, where, orderBy, out   recordCount, doCount);
        }
