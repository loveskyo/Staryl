...
namespace Staryl.BLL
{
   ...
   public partial class PhotoManager:BaseManager
   {
   private static readonly IPhotoDAL dal = DataAccess<IPhotoDAL>.CreateObject("PhotoDAL");
                    ...
                    public bool CreateList(List<PhotoInfo>  list)
                    { 
