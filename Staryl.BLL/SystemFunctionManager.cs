...
namespace Staryl.BLL
{
   ...
   public partial class SystemFunctionManager:BaseManager
   {
   private static readonly ISystemFunctionDAL dal = DataAccess<ISystemFunctionDAL>.CreateObject("SystemFunctionDAL");
                    ...
                    public bool CreateList(List<SystemFunctionInfo>  list)
                    { 
        ...
        {
           return  dal.GetByFunctionCode(  FunctionCode);
        }
   }
}
