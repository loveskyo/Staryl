...
namespace Staryl.BLL
{
   ...
   public partial class TicketManager:BaseManager
   {
   private static readonly ITicketDAL dal = DataAccess<ITicketDAL>.CreateObject("TicketDAL");
                    ...
                    public bool CreateList(List<TicketInfo>  list)
                    { 
        ...
        {
           return  dal.GetByTicketNo(  TicketNo);
        }
   }
}
