...
namespace Staryl.BLL
{
   ...
   public partial class SystemMenuManager:BaseManager
   {
   private static readonly ISystemMenuDAL dal = DataAccess<ISystemMenuDAL>.CreateObject("SystemMenuDAL");
                    ...
                    public bool CreateList(List<SystemMenuInfo>  list)
                    { 
        ...
        {
           return  dal.GetByMenuAddr(  MenuAddr);
        }
   }
}
