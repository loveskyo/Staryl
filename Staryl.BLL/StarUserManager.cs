...
namespace Staryl.BLL
{
   ...
   public partial class StarUserManager:BaseManager
   {
   private static readonly IStarUserDAL dal = DataAccess<IStarUserDAL>.CreateObject("StarUserDAL");
                    ...
                    public bool CreateList(List<StarUserInfo>  list)
                    { 
