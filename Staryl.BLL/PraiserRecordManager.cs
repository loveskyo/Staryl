...
namespace Staryl.BLL
{
   ...
   public partial class PraiserRecordManager:BaseManager
   {
   private static readonly IPraiserRecordDAL dal = DataAccess<IPraiserRecordDAL>.CreateObject("PraiserRecordDAL");
                    ...
                    public bool CreateList(List<PraiserRecordInfo>  list)
                    { 
