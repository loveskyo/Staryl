...
namespace Staryl.BLL
{
   ...
   public partial class SystemLogManager:BaseManager
   {
   private static readonly ISystemLogDAL dal = DataAccess<ISystemLogDAL>.CreateObject("SystemLogDAL");
                    ...
                    public bool CreateList(List<SystemLogInfo>  list)
                    { 
