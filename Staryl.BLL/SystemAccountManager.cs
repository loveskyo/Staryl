...
namespace Staryl.BLL
{
   ...
   public partial class SystemAccountManager:BaseManager
   {
   private static readonly ISystemAccountDAL dal = DataAccess<ISystemAccountDAL>.CreateObject("SystemAccountDAL");
                    ...
                    public bool CreateList(List<SystemAccountInfo>  list)
                    { 
